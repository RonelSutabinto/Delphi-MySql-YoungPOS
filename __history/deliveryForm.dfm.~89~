object deliveryFrm: TdeliveryFrm
  ...
  object deliveryQ: TMyQuery
    ...
    SQL.Strings = (
      'Select * from delivery where idjo = :idjo')
    Left = 392
    Top = 88
    ParamData = <
      item
  ...
  object deliveryDS: TMyDataSource
    DataSet = deliveryQ
    Left = 392
    Top = 128
  end
  object joQ: TMyQuery
    ...
    SQL.Strings = (
        ...
        'Select joborder.*,date_format(date,'#39'%m/%d/%Y'#39') as strTmp from jo' +
        'border where idjo = :idjo')
    Left = 480
    Top = 80
    ParamData = <
      item
  ...
  object deliverytrailQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'insert into deliverytrail'
      '( iddelivery,'
      '  noDelivery,'
      '  deliverydate,'
      '  deliveredBy,'
      ...
      ''
        ...
        '(Select delivery.*,:executedBy,:executedDate from delivery where' +
  ...
  object insertdeliveryDetailsQ: TMyQuery
    ...
    SQL.Strings = (
      ...
      '  article, '
        ...
        '  (jodetails.quantity - ifnull((Select sum(ifnull(d.quantity,0))' +
        ' from deliverydtls d where d.idjodetails = jodetails.idjodetails' +
        '),0) ) as quantity,'
      '  amount,'
      '  :jono,'
      '  :deliveryno,'
      '  :iddelivery '
      'from jodetails where idjo = :idjo and'
      
        '     (jodetails.quantity - ifnull((Select sum(ifnull(d.quantity,' +
        '0)) from deliverydtls d where d.idjodetails = jodetails.idjodeta' +
        'ils),0) )>0'
      ')'
      '')
    Left = 152
  ...
  object deleteDetailsQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'delete from deliverydtls where iddelivery= :iddelivery')
    Left = 200
    Top = 176
    ParamData = <
      item
