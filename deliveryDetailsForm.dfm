object deliveryDetailsFrm: TdeliveryDetailsFrm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'deliveryDetailsFrm'
  ClientHeight = 611
  ClientWidth = 871
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object AdvSmoothLabel1: TAdvSmoothLabel
      ...
      CaptionShadow.Text = '    Delivery Details'
  ...
  object AdvPanel2: TAdvPanel
    ...
    object AdvPanel3: TAdvPanel
      ...
      object deliveredBy_tf: TAdvLUEdit
        Left = 554
        Top = 37
        Width = 245
        Height = 21
  ...
  object NxHeaderPanel3: TNxHeaderPanel
    ...
    Width = 537
    Height = 296
    Caption = 'Select Delivery Articles'
    Color = clWhite
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
  ...
  object deliveryQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'Select * from delivery where iddelivery = :iddelivery')
    Left = 776
    Top = 80
    ParamData = <
      item
    ...
    object deliveryQiddelivery: TIntegerField
      FieldName = 'iddelivery'
    end
    object deliveryQnoDelivery: TIntegerField
      FieldName = 'noDelivery'
    end
    object deliveryQdeliverydate: TDateField
      FieldName = 'deliverydate'
    end
    object deliveryQdeliveredBy: TStringField
      FieldName = 'deliveredBy'
      Size = 45
    end
    object deliveryQjoNo: TIntegerField
      FieldName = 'joNo'
    end
    object deliveryQidjo: TIntegerField
      FieldName = 'idjo'
    end
    object deliveryQremarks: TStringField
      FieldName = 'remarks'
      Size = 400
    end
    object deliveryQusername: TStringField
      FieldName = 'username'
      Size = 45
    end
    object deliveryQreceievedBy: TStringField
      FieldName = 'receievedBy'
      Size = 45
    end
  end
  object deliveryDetailQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'Select * from deliverydtls where iddelivery = :iddelivery')
    Left = 784
    Top = 40
    ParamData = <
      item
    ...
    object deliveryDetailQiddeliverydtls: TIntegerField
      FieldName = 'iddeliverydtls'
    end
    object deliveryDetailQdeliveryno: TIntegerField
      FieldName = 'deliveryno'
    end
    object deliveryDetailQiddelivery: TIntegerField
      FieldName = 'iddelivery'
    end
    object deliveryDetailQidjo: TIntegerField
      FieldName = 'idjo'
    end
    object deliveryDetailQdate: TDateTimeField
      FieldName = 'date'
    end
    object deliveryDetailQarticle: TStringField
      FieldName = 'article'
      Size = 400
    end
    object deliveryDetailQquantity: TFloatField
      FieldName = 'quantity'
    end
    object deliveryDetailQamount: TFloatField
      FieldName = 'amount'
    end
    object deliveryDetailQjono: TIntegerField
      FieldName = 'jono'
    end
    object deliveryDetailQidjodetails: TIntegerField
      FieldName = 'idjodetails'
    end
  end
  object deliveryDetailDS: TMyDataSource
    DataSet = deliveryDetailQ
    Left = 688
    Top = 40
  end
  object jodetailsQ: TMyQuery
    ...
    SQL.Strings = (
      ...
      '    jod.article,'
        ...
        '    ifnull(jod.quantity,0) - ifnull((Select sum(ifnull(d.quantit' +
        'y,0)) from deliverydtls d where d.idjodetails = jod.idjodetails)' +
        ',0) as quantity,'
      '    jod.amount,'
      '    jod.idjo,'
      '    jod.idjodetails'
      ''
      '  from jodetails jod where jod.idjo = :idjo'
      ') f where f.quantity>0')
    Left = 480
    Top = 112
    ParamData = <
      item
  ...
  object jodetailsDS: TMyDataSource
    DataSet = jodetailsQ
    Left = 520
    Top = 112
  end
  object insertdeliveryDetailsQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'insert into deliverydtls'
      '( idjodetails,  '
      '  idjo,'
      '  date,'
      '  article,'
  ...
  object updateDeliverydetailQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'update deliverydtls set'
      '  quantity = :quantity,'
      '  date     = :date  '
      'where iddeliverydtls = :iddeliverydtls')
    Left = 768
    Top = 184
    ParamData = <
      item
  ...
  object clearDetailsQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'Delete '
      'from deliverydtls '
      'where idjodetails = :idjodetails and '
      
        '       ifnull((Select iddelivery from delivery where delivery.id' +
        'delivery = deliverydtls.iddelivery),'#39#39') = '#39#39
      ''
      '/*Delete '
      
        'from deliverydtls where idjodetails = :idjodetails and not exist' +
        's (Select * from delivery where delivery.iddelivery = deliverydt' +
        'ls.iddelivery)'
      '*/')
    Left = 392
    Top = 312
  ...
  object deleteArticleQ: TMyQuery
    Connection = DataModl.MyConnection1
    SQL.Strings = (
      'Delete from deliverydtls where iddeliverydtls = :iddeliverydtls')
    Left = 448
    Top = 48
    ParamData = <
      item
