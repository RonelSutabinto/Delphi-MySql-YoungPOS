...
begin
  ...
  begin
    ...
    insertJODetailQ.ParamByName('quantity').Text            := stringreplace(qnty_tf.Text, ',', '',[rfReplaceAll, rfIgnoreCase]) ;
                                                             //  strtofloat(stringreplace(qnty_tf.Text, ',', '',
                                                             //                [rfReplaceAll, rfIgnoreCase]) );
    insertJODetailQ.ParamByName('amount').Text              := stringreplace(amnt_tf.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
    insertJODetailQ.ParamByName('discount').Text            := stringreplace(discount.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
    insertJODetailQ.ParamByName('vat').Text                 := stringreplace(vat.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
  ...
  begin
    ...
    updateJODetailQ.ParamByName('quantity').Text            := stringreplace(qnty_tf.Text, ',', '',[rfReplaceAll, rfIgnoreCase]) ;
    updateJODetailQ.ParamByName('amount').Text              := stringreplace(amnt_tf.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
    updateJODetailQ.ParamByName('discount').Text            := stringreplace(discount.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
    updateJODetailQ.ParamByName('vat').Text                 := stringreplace(vat.Text, ',', '',[rfReplaceAll, rfIgnoreCase]);
