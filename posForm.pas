...
begin
  ...
  if not tmpQ.IsEmpty then
  begin
    messageDlg('OR number already exist..',mtError,[mbOK],0);
    AdvLUEdit5.SetFocus;
    exit;
  end;
...
begin
  ...
  insertCanceldQ.ParamByName('joNumber').AsInteger       := collectionQjoNumber.AsInteger;
  ...
  insertCanceldQ.ParamByName('reason').Text         :=reason_tf.Text;
